...
const Generate = () => {
  ...
  const handleGenerate = async()=>{
    if(!isLoggedIn) return toast.error('Please login to generate thumnails');
    if(!title.trim()) return toast.error('Title isRequired')
      setLoading(true)
      const api_payload={
        title,
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:ring-2 focus:ring-pink-500"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-lg borber border-white/10 bg-white/6 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none
                   "
                    ></textarea>
                  </div>
                </div>
