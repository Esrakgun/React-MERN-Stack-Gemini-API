    ...
    return (
        ...
        >
            <div>
                ...
                >
                   Join thousand of creatons using AI to boost their CTR.
                </motion.p>
            </div>
            <motion.button onClick={()=>navigate('/ganerate')} className="px-12 py-3 text-slate-800 bg-white hover:bg-slate-200 rounded-full text-sm mt-4"
                initial={{ y: 80, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                viewport={{ once: true }}
                transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
